...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <h1 class="h3 text-gray-800">Edit Periode</h1>
    </div>

    <div class="card shadow">
        <div class="card-body">
            {{-- form untuk update --}}
            <form action="{{ route('periode.update', $periode->uuid) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="periode" id="periode" class="form-control @error('periode') is-invalid @enderror"
                           placeholder="Contoh: 25/26-1" value="{{ old('periode', $periode->periode) }}" required>
                    @error('periode')
