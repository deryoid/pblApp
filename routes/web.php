...
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::prefix('evaluasi')->name('admin.evaluasi.')->group(function () {
        ...
        Route::get('nilai-ap/show-by-aktivitas-list/{aktivitasList}', [AdminEval::class, 'getNilaiAPByAktivitasList'])->name('nilai-ap.show-by-aktivitas-list')->where('aktivitasList', '[0-9]+');
        Route::post('nilai-ap', [AdminEval::class, 'storeNilaiAP'])->name('nilai-ap.store');
        Route::post('nilai-ap/per-aktivitas-list', [AdminEval::class, 'storeNilaiAPPerAktivitasList'])->name('nilai-ap.store-per-aktivitas-list');
...
Route::prefix('mahasiswa')->middleware(['auth', 'mahasiswa'])->group(function () {
    ...
    Route::get('kunjungan/{id:uuid}/bukti', [\App\Http\Controllers\Mahasiswa\KunjunganMitraController::class, 'getBukti'])->name('mahasiswa.kunjungan.bukti');
